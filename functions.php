...
/*
    ...
    below append by shuding @ 2014.8.21
    ds303077135@gmail.com

    CMS dir tree for posts and pages

    docs file system based on wordpress
...
function docs_dir_select_form() {
    ...
    echo $edit_post_dir;
    echo '</p>';
    echo '<link rel="stylesheet" href="' . get_template_directory_uri() . '/css/font-awesome.css"/>';
    echo '<link rel="stylesheet" href="' . get_template_directory_uri() . '/css/docs-dir-select.css"/>';
    ...
    echo '<script src="' . get_template_directory_uri() . '/js/docs-dir-select.js"></script>';
    echo '</div>';
    echo "</div>";
}
